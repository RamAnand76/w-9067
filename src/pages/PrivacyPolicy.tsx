        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-6">Last updated October 21, 2025</p>
              ...
              <p className="text-gray-600 mb-4">The information we collect includes:</p>
              <ul className="list-disc pl-6 mb-4 text-gray-600">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">7. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
              <p className="text-gray-600 mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">8. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
              <p className="text-gray-600 mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">9. PRE-EXISTING GARMENT DAMAGE DISCLAIMER</h2>
              <p className="text-gray-600 mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">11. INTERNAL PRIVACY COMPLIANCE CONTACT</h2>
              <p className="text-gray-600 mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">12. VENDOR AND CUSTOMER RESPONSIBILITIES</h2>
              <p className="text-gray-600 mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
              <p className="text-gray-600 mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
              <p className="text-gray-600 mb-4">
