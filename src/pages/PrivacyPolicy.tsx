        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">SUMMARY OF KEY POINTS</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">TABLE OF CONTENTS</h2>
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">1. WHAT INFORMATION DO WE COLLECT?</h2>
              <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Personal information you disclose to us</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Information automatically collected</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Google API</h3>
              <p className="mb-4">
                  Our use of information received from Google APIs will adhere to Google API Services User Data Policy, including the Limited Use requirements.
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3 text-foreground">Google Analytics</h3>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">7. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">8. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">9. PRE-EXISTING GARMENT DAMAGE DISCLAIMER</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">10. DATA RETENTION</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">11. INTERNAL PRIVACY COMPLIANCE CONTACT</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">12. VENDOR AND CUSTOMER RESPONSIBILITIES</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-semibold mt-8 mb-4 text-foreground">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
              <p className="mb-4">
