      ...
      <div className="container mx-auto px-4">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-teal-300">{benefit.subtitle}</p>
                </div>
              </div>
        ...
        <div className="text-center mt-12">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-4 text-teal-300">Join the Go Bright Revolution</h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Be part of India's digital laundry transformation. Download the app or partner with us today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-3 bg-teal-600 text-white rounded-md hover:bg-teal-700 transition-colors flex items-center justify-center">
                <Smartphone className="mr-2 w-5 h-5" />
                Download App
              </button>
              <button className="px-8 py-3 bg-transparent border border-teal-600 text-teal-300 rounded-md hover:bg-teal-600 hover:text-white transition-colors">
                Partner With Us
              </button>
            </div>
          </motion.div>
