...
const Hero = () => {
  ...
  return <motion.div className="relative w-full mb-8 pt-16 md:pt-0" initial="hidden" animate="visible" variants={containerVariants}>
      <div className="banner-container bg-gradient-to-br from-teal-600 to-teal-700 dark:from-teal-700 dark:to-teal-800 relative overflow-hidden h-[95vh] sm:h-[105vh] md:h-[800px] w-full">
              ...
              <motion.div className="mt-8 mb-6 flex justify-center items-center" variants={itemVariants}>
                ...
                >
                  <div className="relative">
                    ...
                    {/* Smoke Animation */}
                    <div className="absolute top-2/3 left-0 -translate-y-1/2 ml-7">
                      {[0, 1, 2].map(i => (
                        <motion.div
                          key={i}
                          custom={i}
